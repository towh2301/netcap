  ...
  return (
    <main className="bg-black min-h-screen text-white pt-20 px-6 md:px-10 lg:px-16 pb-10">
      <header className="flex flex-col md:flex-row md:items-end md:justify-between gap-3 mb-6">
        <div>
          <h1 className="text-2xl md:text-3xl font-bold py-3">Country: {slug.replace(/-/g, " ")}</h1>
        ...
        <div className="text-sm text-gray-400">Page {pagination?.currentPage ?? page} / {pagination?.totalPages ?? 1}{isFetching ? " · Updating..." : ""}</div>
      </header>
