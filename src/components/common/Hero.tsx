			...
			<div className="relative z-10 px-6 md:px-12 top-1/2 -translate-y-1/2">
				...
				<div className="mt-6 flex gap-4">
					<Link href={`/watch/${movie?.slug}`}>
						<button
							className="rounded bg-white px-6 py-2 font-semibold text-black hover:bg-gray-200 transition">
							Play
						</button>
					</Link>
					{/*<button*/}
					{/*	className="rounded bg-gray-700/80 px-6 py-2 font-semibold text-white hover:bg-gray-600 transition">*/}
					{/*	More Info*/}
					{/*</button>*/}
				</div>
			</div>
