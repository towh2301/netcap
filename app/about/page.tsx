...
import { Github, Film, Zap, Shield, Sparkles, ArrowRight } from "lucide-react";

// Optional page metadata (App Router). If you place this file under app/about/page.tsx,
// move this export to a layout file or convert to named export `metadata`.
